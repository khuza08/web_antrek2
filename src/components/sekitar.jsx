    ...
    <section className="py-16 bg-blue-100 dark:bg-slate-900">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <a 
            href="https://www.instagram.com/your-school" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-full transition duration-200 shadow-lg hover:shadow-blue-500/20"
          >
