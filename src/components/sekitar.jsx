      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <a 
            ...
            className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition duration-200 shadow-lg hover:shadow-blue-500/20"
          >
